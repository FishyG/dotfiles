...
linux_version="$(uname -s):<span foreground='#ff33dd'> $(uname -r | cut -d '-' -f1)</span>"
...
echo "<span font='VictorMono Nerd Font medium Italic 10'>$ram_usage | $cpu_usage | $linux_version | $date_formatted </span>"
